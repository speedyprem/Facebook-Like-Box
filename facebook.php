	...
	function form($instance)
	{
		...
		<div class="widget">
			<p>
				...
				<input class="widefat" id="<?php echo $this->get_field_id('title'); ?>" name="<?php echo $this->get_field_name('title'); ?>" type="text" placeholder="e.g: Follow us" value="<?php echo esc_attr($instance['title']); ?>" />
			</p>
			<p>
				<label for="<?php echo $this->get_field_id('url'); ?>">Page URL:</label>
				<input class="widefat" id="<?php echo $this->get_field_id('url'); ?>" name="<?php echo $this->get_field_name('url'); ?>" type="text" placeholder="e.g: https://www.facebook.com/freewebmentor/" value="<?php echo esc_attr($instance['url']); ?>" />
			</p>
			<p>
				<b>Advance Options:</b>
			</p>
			...
			<p>
				<input type="text" style="width: 80px;" name="<?php echo $this->get_field_name('border'); ?>" placeholder="e.g: #ffffff" value="<?php echo esc_attr($instance['border']); ?>" />
