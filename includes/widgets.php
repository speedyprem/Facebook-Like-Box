...
class ThematerFacebook extends WP_Widget 
{
    ...
    function widget($args, $instance)
    {
        ...
        <?php  if ( $title ) {  ?> <h3 class="widgettitle"><?php echo $title; ?></h3> <?php }  ?>
            ...
            <div class="fb-like-box" data-href="<?php echo $url; ?>" data-width="100%" data-colorscheme="<?php echo $colorscheme; ?>" data-show-faces="<?php echo $show_faces; ?>" data-stream="<?php echo $stream; ?>" data-header="<?php echo $header; ?>" data-border-color="<?php echo $border; ?>"></div>
